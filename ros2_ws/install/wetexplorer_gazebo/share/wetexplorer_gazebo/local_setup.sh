...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/install/wetexplorer_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/wetexplorer_gazebo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/wetexplorer_gazebo/environment/path.sh"
